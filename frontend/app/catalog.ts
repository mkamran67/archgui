...
export const apps: CatalogApp[] = [
  ...
  },
  {
    ...
    repo: "https://github.com/vinifmor/bauh", license: "ZLIB", stars: "1.2k",
  ...
  },
  {
    ...
    repo: "https://github.com/oguzhaninan/Stacer", license: "GPL-3.0", stars: "9.1k",
  ...
  },
  {
    ...
    distros: [["Arch Linux", "Stable"], ["Manjaro", "Stable"], ["EndeavourOS", "Stable"]],
    repo: "https://github.com/d4nj1/TLPUI", license: "GPL-2.0", stars: "1.1k",
  ...
  },
  {
    ...
    repo: "https://github.com/linuxmint/timeshift", license: "GPL-3.0", stars: "3.4k",
  ...
  },
  {
    ...
    description: "Grub Customizer lets you reorder boot entries, set a default OS, change the timeout, edit kernel parameters and tweak the menu theme - all without hand-editing grub.cfg by hand.",
    ...
    repo: "https://launchpad.net/grub-customizer", license: "GPL-3.0", stars: "-",
  ...
  },
  {
    ...
    repo: "https://invent.kde.org/plasma/discover", license: "GPL-2.0", stars: "-",
